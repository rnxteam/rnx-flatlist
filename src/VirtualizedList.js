...
// export type renderItemType = (info) => ?React.Element<any>;
...
//   /**
//    * The default accessor functions assume this is an Array<{key}> but you can override
...
//    */
//   renderScrollComponent?: (props) => React.Element<any>,
//   /**
...
class CellRenderer extends React.PureComponent {
  ...
  _separators = {
    ...
    updateProps: (select: 'leading' | 'trailing', newProps) => {
      const { cellKey, prevCellKey } = this.props;
